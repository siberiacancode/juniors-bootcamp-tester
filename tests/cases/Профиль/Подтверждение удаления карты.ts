...
const cardDeleteConfirmationPreconditions = createPreconditions({
...
export default createTestCases([
  ...
  {
    id: CASE_IDS.DELETE_CARD_LOADING,
  ...
  {
    id: CASE_IDS.DELETE_CARD_SUCCESS,

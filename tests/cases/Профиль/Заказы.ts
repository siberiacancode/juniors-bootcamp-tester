...
const ordersPreconditions = createPreconditions({
...
export default createTestCases([
  ...
  {
    id: CASE_IDS.ORDERS_EMPTY_DESIGN,
  ...
  {
    id: CASE_IDS.ORDERS_EMPTY_CATALOG,
